...
LABEL org.opencontainers.image.title="ReleaseHound"
...
LABEL org.opencontainers.image.source="https://github.com/SeisoLLC/release_hound"
...
COPY ./release_hound ./release_hound/
COPY ./main.py ./
